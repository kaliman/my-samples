...
public class InstantiateUsingOnlyThread {
	...
	public static void main(String[] args) {
		...
		Thread thread1 = new MyTask("thread1 - any data that the thread may need to process");
		Thread thread2 = new MyTask("thread2 - any data that the thread may need to process");
		thread1.start();
		thread2.start();
